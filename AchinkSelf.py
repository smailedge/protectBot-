...
admin = ["ucf9951cca797709b8a2bca18941740f2"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    ...
    #-----------------=Selesai=------------------
            ...
            ##if msg.from_ in admin:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["Buka qr","Open qr","Ourl","Buka lawang","Buka"]:
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
            ...
            elif msg.text in ["Tutup qr","Tutup lawang","Curl","Close","Tutup"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
                        ...
                        cl.updateGroup(H)
                        print "Geus hadir kabeh"
    #----------------------Fungsi Join Group Finish---------------#

    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Indit"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                  cl.getGroup(msg.to)
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Tukang Sapu Mau Bersih² Group Sampah Nih")
                    cl.sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'ucf9951cca797709b8a2bca18941740f2'}
                    cl.sendMessage(msg)
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["nyebut"]:
              #if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Tikung On")
                ki.sendText(msg.to,"Tukang Gombal On")
                ki2.sendText(msg.to,"Tukang Bohong On")
                cl.sendText(msg.to,"Geus hadir kabeh Chink\nSiap Protect Group\nAman Teu Aman Nu Penting Anu\nUlah poho sesaan nu semok\njeung Kang Achink")
